...
public class PhoneNumber extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2301596796272843916L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PhoneNumber\",\"namespace\":\"haken.advertiser\",\"fields\":[{\"name\":\"areaCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"countryCode\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"\"},{\"name\":\"prefix\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"number\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static haken.advertiser.PhoneNumber.Builder newBuilder() {
    return new haken.advertiser.PhoneNumber.Builder();
  }
   ...
   * @return A new PhoneNumber RecordBuilder
   */
  public static haken.advertiser.PhoneNumber.Builder newBuilder(haken.advertiser.PhoneNumber.Builder other) {
    return new haken.advertiser.PhoneNumber.Builder(other);
  }
   ...
   * @return A new PhoneNumber RecordBuilder
   */
  public static haken.advertiser.PhoneNumber.Builder newBuilder(haken.advertiser.PhoneNumber other) {
    return new haken.advertiser.PhoneNumber.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PhoneNumber>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(haken.advertiser.PhoneNumber.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(haken.advertiser.PhoneNumber other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.areaCode)) {
        this.areaCode = data().deepCopy(fields()[0].schema(), other.areaCode);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public haken.advertiser.PhoneNumber.Builder setAreaCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public haken.advertiser.PhoneNumber.Builder clearAreaCode() {
      areaCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public haken.advertiser.PhoneNumber.Builder setCountryCode(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public haken.advertiser.PhoneNumber.Builder clearCountryCode() {
      countryCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public haken.advertiser.PhoneNumber.Builder setPrefix(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public haken.advertiser.PhoneNumber.Builder clearPrefix() {
      prefix = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public haken.advertiser.PhoneNumber.Builder setNumber(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public haken.advertiser.PhoneNumber.Builder clearNumber() {
      number = null;
